...
import fr.aeryacraft.item.AeryaItem;
...
public class Item {
	...
	private boolean isInfusable = false;
	...
	private MeshModel meshModel = null;
	...
	public Item setInfusable(boolean infusable) {
		isInfusable = infusable;
		return this;
	}
	
	public Item setMeshModel(MeshModel meshModel) {
		this.meshModel = meshModel;
		return this;
	}
	
	public boolean haveMesh() {
	...
	public static void registerItems() {
		...
		registerItemBlock(Blocks.red_flower,
				(new ItemMultiTexture(Blocks.red_flower, Blocks.red_flower, new Function() {
					private static final String __OBFID = "CL_00002176";

					public String apply(ItemStack stack) {
						return BlockFlower.EnumFlowerType
								.func_176967_a(BlockFlower.EnumFlowerColor.RED, stack.getMetadata()).func_176963_d();
					}
		...
		registerItemBlock(Blocks.stonebrick,
				(new ItemMultiTexture(Blocks.stonebrick, Blocks.stonebrick, new Function() {
		...
		registerItemBlock(Blocks.prismarine,
				(new ItemMultiTexture(Blocks.prismarine, Blocks.prismarine, new Function() {
		...
		registerItem(267, "iron_sword", (new ItemSword(Item.ToolMaterial.IRON)).setUnlocalizedName("swordIron").setInfusable(true));
		registerItem(268, "wooden_sword", (new ItemSword(Item.ToolMaterial.WOOD)).setUnlocalizedName("swordWood").setInfusable(true));
		...
		registerItem(272, "stone_sword", (new ItemSword(Item.ToolMaterial.STONE)).setUnlocalizedName("swordStone").setInfusable(true));
		...
		registerItem(276, "diamond_sword",
				(new ItemSword(Item.ToolMaterial.EMERALD)).setUnlocalizedName("swordDiamond").setInfusable(true));
	...
	public static enum ToolMaterial {
		WOOD("WOOD", 0, 0, 59, 2.0F, 0.0F, 15), STONE("STONE", 1, 1, 131, 4.0F, 1.0F, 5),
		IRON("IRON", 2, 2, 250, 6.0F, 2.0F, 14), EMERALD("EMERALD", 3, 3, 1561, 8.0F, 3.0F, 10),
		GOLD("GOLD", 4, 0, 32, 12.0F, 0.0F, 22), AERYA("AERYA", 5, 8, 3158, 11.0F, 3.0F, 10),
		ELADRITE("ELADRITE", 6, 6, 2720, 8.0F, 3.0F, 10), AMETHYSTE("AMETYSTE", 7, 5, 2350, 6.0F, 3.0F, 10),
		AVENTURINE("AVENTURINE", 8, 7, 2950, 10.0F, 3.0F, 10), LEGEND("LEGEND", 9, 8, 6950, 11.0F, 5.0F, 25),
		TOURMALINE("TOURMALINE", 10, 7, 2720, 9.0F, 3.0F, 10);
		...
		private ToolMaterial(String p_i1874_1_, int p_i1874_2_, int harvestLevel, int maxUses, float efficiency,
				float damageVsEntity, int enchantability) {
