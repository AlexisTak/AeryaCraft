...
public class DifficultyInstance {
   ...
   private float func_180169_a(EnumDifficulty p_180169_1_, long p_180169_2_, long p_180169_4_, float p_180169_6_) {
      if(p_180169_1_ == EnumDifficulty.PEACEFUL) {
         ...
         float var8 = 0.75F;
         float var9 = MathHelper.func_76131_a(((float)p_180169_2_ + -72000.0F) / 1440000.0F, 0.0F, 1.0F) * 0.25F;
         var8 += var9;
         float var10 = 0.0F;
         var10 += MathHelper.func_76131_a((float)p_180169_4_ / 3600000.0F, 0.0F, 1.0F) * (var7?1.0F:0.75F);
         var10 += MathHelper.func_76131_a(p_180169_6_ * 0.25F, 0.0F, var9);
         if(p_180169_1_ == EnumDifficulty.EASY) {
            var10 *= 0.5F;
         }

         var8 += var10;
         return (float)p_180169_1_.func_151525_a() * var8;
      }
   }
}
