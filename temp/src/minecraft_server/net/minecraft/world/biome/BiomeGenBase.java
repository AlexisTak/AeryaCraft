...
public abstract class BiomeGenBase {
   ...
   public final float func_180626_a(BlockPos p_180626_1_) {
      if(p_180626_1_.func_177956_o() > 64) {
         float var2 = (float)(field_150605_ac.func_151601_a((double)p_180626_1_.func_177958_n() * 1.0D / 8.0D, (double)p_180626_1_.func_177952_p() * 1.0D / 8.0D) * 4.0D);
         return this.field_76750_F - (var2 + (float)p_180626_1_.func_177956_o() - 64.0F) * 0.05F / 30.0F;
      } else {
   ...
   public final void func_180628_b(World p_180628_1_, Random p_180628_2_, ChunkPrimer p_180628_3_, int p_180628_4_, int p_180628_5_, double p_180628_6_) {
      ...
      for(int var15 = 255; var15 >= 0; --var15) {
         if(var15 <= p_180628_2_.nextInt(5)) {
            p_180628_3_.func_177855_a(var14, var15, var13, Blocks.field_150357_h.func_176223_P());
         } else {
            IBlockState var16 = p_180628_3_.func_177856_a(var14, var15, var13);
            if(var16.func_177230_c().func_149688_o() == Material.field_151579_a) {
               var11 = -1;
            } else if(var16.func_177230_c() == Blocks.field_150348_b) {
               if(var11 == -1) {
                  if(var12 <= 0) {
                     var9 = null;
                  ...
                  if(var15 < 63 && (var9 == null || var9.func_177230_c().func_149688_o() == Material.field_151579_a)) {
                  ...
                  var11 = var12;
                  if(var15 >= 62) {
                     p_180628_3_.func_177855_a(var14, var15, var13, var9);
                  } else if(var15 < 56 - var12) {
                     var9 = null;
                     var10 = Blocks.field_150348_b.func_176223_P();
                     p_180628_3_.func_177855_a(var14, var15, var13, Blocks.field_150351_n.func_176223_P());
                  } else {
                     p_180628_3_.func_177855_a(var14, var15, var13, var10);
                  }
               } else if(var11 > 0) {
                  --var11;
                  p_180628_3_.func_177855_a(var14, var15, var13, var10);
   ...
   public static BiomeGenBase func_180276_a(int p_180276_0_, BiomeGenBase p_180276_1_) {
      if(p_180276_0_ >= 0 && p_180276_0_ <= field_76773_a.length) {
         BiomeGenBase var2 = field_76773_a[p_180276_0_];
