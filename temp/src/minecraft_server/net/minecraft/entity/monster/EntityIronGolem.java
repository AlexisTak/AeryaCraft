            ...
            public boolean func_180096_a(EntityLivingBase p_180096_1_) {
               if(p_i45858_6_ != null && !p_i45858_6_.apply(p_180096_1_)) {
                  ...
                  if(p_180096_1_ instanceof EntityPlayer) {
                     ...
                     if(p_180096_1_.func_70093_af()) {
                        var2 *= 0.800000011920929D;
                     }

                     if(p_180096_1_.func_82150_aj()) {
                        float var4 = ((EntityPlayer)p_180096_1_).func_82243_bO();
                        if(var4 < 0.1F) {
                           var4 = 0.1F;
                        }
                     ...
                     if((double)p_180096_1_.func_70032_d(p_i45858_1_) > var2) {
                        return false;
                     }
                  }

                  return AINearestAttackableTargetNonCreeper.this.func_75296_a(p_180096_1_, false);
               }
            }
            // $FF: synthetic method
