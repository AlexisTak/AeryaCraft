...
public class EntityWolf extends EntityTameable {
      ...
      if(this.func_70026_G()) {
         ...
         if(this.field_70929_i > 0.4F) {
            ...
            for(int var3 = 0; var3 < var2; ++var3) {
               ...
               this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_SPLASH, this.field_70165_t + (double)var4, (double)(var1 + 0.8F), this.field_70161_v + (double)var5, this.field_70159_w, this.field_70181_x, this.field_70179_y, new int[0]);
            }
         }
      }
   ...
   public boolean func_70652_k(Entity p_70652_1_) {
      boolean var2 = p_70652_1_.func_70097_a(DamageSource.func_76358_a(this), (float)((int)this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111126_e()));
      if(var2) {
   ...
   public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
      if(!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
         if(p_142018_1_ instanceof EntityWolf) {
            ...
            if(var3.func_70909_n() && var3.func_180492_cm() == p_142018_2_) {
               return false;
            }
         }
