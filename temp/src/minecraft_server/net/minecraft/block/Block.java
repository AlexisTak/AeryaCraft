...
public class Block {
   ...
   public static Block func_149684_b(String p_149684_0_) {
      ResourceLocation var1 = new ResourceLocation(p_149684_0_);
   ...
   public void func_180638_a(World p_180638_1_, BlockPos p_180638_2_, IBlockState p_180638_3_, AxisAlignedBB p_180638_4_, List p_180638_5_, Entity p_180638_6_) {
      AxisAlignedBB var7 = this.func_180640_a(p_180638_1_, p_180638_2_, p_180638_3_);
      if(var7 != null && p_180638_4_.func_72326_a(var7)) {
         p_180638_5_.add(var7);
      }
   ...
   public float func_180647_a(EntityPlayer p_180647_1_, World p_180647_2_, BlockPos p_180647_3_) {
      float var4 = this.func_176195_g(p_180647_2_, p_180647_3_);
      return var4 < 0.0F?0.0F:(!p_180647_1_.func_146099_a(this)?p_180647_1_.func_180471_a(this) / var4 / 100.0F:p_180647_1_.func_180471_a(this) / var4 / 30.0F);
   }
   ...
   public void func_180653_a(World p_180653_1_, BlockPos p_180653_2_, IBlockState p_180653_3_, float p_180653_4_, int p_180653_5_) {
      if(!p_180653_1_.field_72995_K) {
         int var6 = this.func_149679_a(p_180653_5_, p_180653_1_.field_73012_v);

         for(int var7 = 0; var7 < var6; ++var7) {
            if(p_180653_1_.field_73012_v.nextFloat() <= p_180653_4_) {
               Item var8 = this.func_180660_a(p_180653_3_, p_180653_1_.field_73012_v, p_180653_5_);
               if(var8 != null) {
                  func_180635_a(p_180653_1_, p_180653_2_, new ItemStack(var8, 1, this.func_180651_a(p_180653_3_)));
               }
            }
         }
   ...
   public static void func_180635_a(World p_180635_0_, BlockPos p_180635_1_, ItemStack p_180635_2_) {
      if(!p_180635_0_.field_72995_K && p_180635_0_.func_82736_K().func_82766_b("doTileDrops")) {
         float var3 = 0.5F;
         double var4 = (double)(p_180635_0_.field_73012_v.nextFloat() * var3) + (double)(1.0F - var3) * 0.5D;
         double var6 = (double)(p_180635_0_.field_73012_v.nextFloat() * var3) + (double)(1.0F - var3) * 0.5D;
         double var8 = (double)(p_180635_0_.field_73012_v.nextFloat() * var3) + (double)(1.0F - var3) * 0.5D;
         EntityItem var10 = new EntityItem(p_180635_0_, (double)p_180635_1_.func_177958_n() + var4, (double)p_180635_1_.func_177956_o() + var6, (double)p_180635_1_.func_177952_p() + var8, p_180635_2_);
         var10.func_174869_p();
         p_180635_0_.func_72838_d(var10);
      }
   }
   ...
   protected void func_180637_b(World p_180637_1_, BlockPos p_180637_2_, int p_180637_3_) {
      if(!p_180637_1_.field_72995_K) {
         while(p_180637_3_ > 0) {
            int var4 = EntityXPOrb.func_70527_a(p_180637_3_);
            p_180637_3_ -= var4;
            p_180637_1_.func_72838_d(new EntityXPOrb(p_180637_1_, (double)p_180637_2_.func_177958_n() + 0.5D, (double)p_180637_2_.func_177956_o() + 0.5D, (double)p_180637_2_.func_177952_p() + 0.5D, var4));
         }
      }
   ...
   public MovingObjectPosition func_180636_a(World p_180636_1_, BlockPos p_180636_2_, Vec3 p_180636_3_, Vec3 p_180636_4_) {
      ...
      Vec3 var5 = p_180636_3_.func_72429_b(p_180636_4_, this.field_149759_B);
      Vec3 var6 = p_180636_3_.func_72429_b(p_180636_4_, this.field_149755_E);
      Vec3 var7 = p_180636_3_.func_72435_c(p_180636_4_, this.field_149760_C);
      Vec3 var8 = p_180636_3_.func_72435_c(p_180636_4_, this.field_149756_F);
      Vec3 var9 = p_180636_3_.func_72434_d(p_180636_4_, this.field_149754_D);
      Vec3 var10 = p_180636_3_.func_72434_d(p_180636_4_, this.field_149757_G);
      ...
      Vec3 var11 = null;
      if(var5 != null && (var11 == null || p_180636_3_.func_72436_e(var5) < p_180636_3_.func_72436_e(var11))) {
         var11 = var5;
      }

      if(var6 != null && (var11 == null || p_180636_3_.func_72436_e(var6) < p_180636_3_.func_72436_e(var11))) {
         var11 = var6;
      }

      if(var7 != null && (var11 == null || p_180636_3_.func_72436_e(var7) < p_180636_3_.func_72436_e(var11))) {
         var11 = var7;
      }

      if(var8 != null && (var11 == null || p_180636_3_.func_72436_e(var8) < p_180636_3_.func_72436_e(var11))) {
         var11 = var8;
      }

      if(var9 != null && (var11 == null || p_180636_3_.func_72436_e(var9) < p_180636_3_.func_72436_e(var11))) {
         var11 = var9;
      }

      if(var10 != null && (var11 == null || p_180636_3_.func_72436_e(var10) < p_180636_3_.func_72436_e(var11))) {
         var11 = var10;
      }
      ...
      if(var11 == null) {
         ...
         return new MovingObjectPosition(var11.func_72441_c((double)p_180636_2_.func_177958_n(), (double)p_180636_2_.func_177956_o(), (double)p_180636_2_.func_177952_p()), var12, p_180636_2_);
      }
   }
   ...
   public void func_180657_a(World p_180657_1_, EntityPlayer p_180657_2_, BlockPos p_180657_3_, IBlockState p_180657_4_, TileEntity p_180657_5_) {
      ...
      if(this.func_149700_E() && EnchantmentHelper.func_77502_d(p_180657_2_)) {
         ItemStack var7 = this.func_180643_i(p_180657_4_);
         if(var7 != null) {
            func_180635_a(p_180657_1_, p_180657_3_, var7);
         }
      } else {
         int var6 = EnchantmentHelper.func_77517_e(p_180657_2_);
         this.func_176226_b(p_180657_1_, p_180657_3_, p_180657_4_, var6);
      }
   ...
   protected ItemStack func_180643_i(IBlockState p_180643_1_) {
      ...
      if(var3 != null && var3.func_77614_k()) {
         var2 = this.func_176201_c(p_180643_1_);
      }
   ...
   public static void func_149671_p() {
      ...
      func_176219_a(22, "lapis_block", (new BlockCompressed(MapColor.field_151652_H)).func_149711_c(3.0F).func_149752_b(5.0F).func_149672_a(field_149780_i).func_149663_c("blockLapis").func_149647_a(CreativeTabs.field_78030_b));
      ...
      func_176219_a(34, "piston_head", new BlockPistonExtension());
      ...
      func_176219_a(41, "gold_block", (new BlockCompressed(MapColor.field_151647_F)).func_149711_c(3.0F).func_149752_b(10.0F).func_149672_a(field_149777_j).func_149663_c("blockGold"));
      func_176219_a(42, "iron_block", (new BlockCompressed(MapColor.field_151668_h)).func_149711_c(5.0F).func_149752_b(10.0F).func_149672_a(field_149777_j).func_149663_c("blockIron"));
      ...
      Block var5 = (new Block(Material.field_151576_e)).func_149711_c(2.0F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("brick").func_149647_a(CreativeTabs.field_78030_b);
      ...
      func_176219_a(57, "diamond_block", (new BlockCompressed(MapColor.field_151648_G)).func_149711_c(5.0F).func_149752_b(10.0F).func_149672_a(field_149777_j).func_149663_c("blockDiamond"));
      ...
      func_176219_a(85, "fence", (new BlockFence(Material.field_151575_d)).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("fence"));
      ...
      func_176219_a(99, "brown_mushroom_block", (new BlockHugeMushroom(Material.field_151575_d, var3)).func_149711_c(0.2F).func_149672_a(field_149766_f).func_149663_c("mushroom"));
      func_176219_a(100, "red_mushroom_block", (new BlockHugeMushroom(Material.field_151575_d, var4)).func_149711_c(0.2F).func_149672_a(field_149766_f).func_149663_c("mushroom"));
      ...
      func_176219_a(107, "fence_gate", (new BlockFenceGate()).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("fenceGate"));
      ...
      func_176219_a(113, "nether_brick_fence", (new BlockFence(Material.field_151576_e)).func_149711_c(2.0F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("netherFence"));
      ...
      func_176219_a(121, "end_stone", (new Block(Material.field_151576_e)).func_149711_c(3.0F).func_149752_b(15.0F).func_149672_a(field_149780_i).func_149663_c("whiteStone").func_149647_a(CreativeTabs.field_78030_b));
      ...
      func_176219_a(133, "emerald_block", (new BlockCompressed(MapColor.field_151653_I)).func_149711_c(5.0F).func_149752_b(10.0F).func_149672_a(field_149777_j).func_149663_c("blockEmerald"));
      ...
      func_176219_a(147, "light_weighted_pressure_plate", (new BlockPressurePlateWeighted("gold_block", Material.field_151573_f, 15)).func_149711_c(0.5F).func_149672_a(field_149766_f).func_149663_c("weightedPlate_light"));
      func_176219_a(148, "heavy_weighted_pressure_plate", (new BlockPressurePlateWeighted("iron_block", Material.field_151573_f, 150)).func_149711_c(0.5F).func_149672_a(field_149766_f).func_149663_c("weightedPlate_heavy"));
      ...
      func_176219_a(152, "redstone_block", (new BlockCompressedPowered(MapColor.field_151656_f)).func_149711_c(5.0F).func_149752_b(10.0F).func_149672_a(field_149777_j).func_149663_c("blockRedstone"));
      func_176219_a(153, "quartz_ore", (new BlockOre()).func_149711_c(3.0F).func_149752_b(5.0F).func_149672_a(field_149780_i).func_149663_c("netherquartz"));
      ...
      func_176219_a(173, "coal_block", (new Block(Material.field_151576_e)).func_149711_c(5.0F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("blockCoal").func_149647_a(CreativeTabs.field_78030_b));
      ...
      func_176219_a(183, "spruce_fence_gate", (new BlockFenceGate()).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("spruceFenceGate"));
      func_176219_a(184, "birch_fence_gate", (new BlockFenceGate()).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("birchFenceGate"));
      func_176219_a(185, "jungle_fence_gate", (new BlockFenceGate()).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("jungleFenceGate"));
      func_176219_a(186, "dark_oak_fence_gate", (new BlockFenceGate()).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("darkOakFenceGate"));
      func_176219_a(187, "acacia_fence_gate", (new BlockFenceGate()).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("acaciaFenceGate"));
      func_176219_a(188, "spruce_fence", (new BlockFence(Material.field_151575_d)).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("spruceFence"));
      func_176219_a(189, "birch_fence", (new BlockFence(Material.field_151575_d)).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("birchFence"));
      func_176219_a(190, "jungle_fence", (new BlockFence(Material.field_151575_d)).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("jungleFence"));
      func_176219_a(191, "dark_oak_fence", (new BlockFence(Material.field_151575_d)).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("darkOakFence"));
      func_176219_a(192, "acacia_fence", (new BlockFence(Material.field_151575_d)).func_149711_c(2.0F).func_149752_b(5.0F).func_149672_a(field_149766_f).func_149663_c("acaciaFence"));
