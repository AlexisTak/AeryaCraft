...
public class BlockCake extends Block {
   ...
   public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
      float var3 = 0.0625F;
      float var4 = (float)(1 + ((Integer)p_180654_1_.func_180495_p(p_180654_2_).func_177229_b(field_176589_a)).intValue() * 2) / 16.0F;
      float var5 = 0.5F;
   ...
   public AxisAlignedBB func_180640_a(World p_180640_1_, BlockPos p_180640_2_, IBlockState p_180640_3_) {
      float var4 = 0.0625F;
      float var5 = (float)(1 + ((Integer)p_180640_3_.func_177229_b(field_176589_a)).intValue() * 2) / 16.0F;
      float var6 = 0.5F;
      return new AxisAlignedBB((double)((float)p_180640_2_.func_177958_n() + var5), (double)p_180640_2_.func_177956_o(), (double)((float)p_180640_2_.func_177952_p() + var4), (double)((float)(p_180640_2_.func_177958_n() + 1) - var4), (double)((float)p_180640_2_.func_177956_o() + var6), (double)((float)(p_180640_2_.func_177952_p() + 1) - var4));
   }
   ...
   private void func_180682_b(World p_180682_1_, BlockPos p_180682_2_, IBlockState p_180682_3_, EntityPlayer p_180682_4_) {
      if(p_180682_4_.func_71043_e(false)) {
         ...
         int var5 = ((Integer)p_180682_3_.func_177229_b(field_176589_a)).intValue();
         if(var5 < 6) {
            p_180682_1_.func_180501_a(p_180682_2_, p_180682_3_.func_177226_a(field_176589_a, Integer.valueOf(var5 + 1)), 3);
         } else {
