...
public class BlockSnow extends Block {
   ...
   public AxisAlignedBB func_180640_a(World p_180640_1_, BlockPos p_180640_2_, IBlockState p_180640_3_) {
      int var4 = ((Integer)p_180640_3_.func_177229_b(field_176315_a)).intValue() - 1;
      float var5 = 0.125F;
      return new AxisAlignedBB((double)p_180640_2_.func_177958_n() + this.field_149759_B, (double)p_180640_2_.func_177956_o() + this.field_149760_C, (double)p_180640_2_.func_177952_p() + this.field_149754_D, (double)p_180640_2_.func_177958_n() + this.field_149755_E, (double)((float)p_180640_2_.func_177956_o() + (float)var4 * var5), (double)p_180640_2_.func_177952_p() + this.field_149757_G);
   }
   ...
   public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
      ...
      this.func_150154_b(((Integer)var3.func_177229_b(field_176315_a)).intValue());
   }
   ...
   public boolean func_176196_c(World p_176196_1_, BlockPos p_176196_2_) {
      IBlockState var3 = p_176196_1_.func_180495_p(p_176196_2_.func_177977_b());
      Block var4 = var3.func_177230_c();
      return var4 != Blocks.field_150432_aD && var4 != Blocks.field_150403_cj?(var4.func_149688_o() == Material.field_151584_j?true:(var4 == this && ((Integer)var3.func_177229_b(field_176315_a)).intValue() == 7?true:var4.func_149662_c() && var4.field_149764_J.func_76230_c())):false;
   }
