...
public class BlockFenceGate extends BlockDirectional {
   ...
   public IBlockState func_176221_a(IBlockState p_176221_1_, IBlockAccess p_176221_2_, BlockPos p_176221_3_) {
      EnumFacing.Axis var4 = ((EnumFacing)p_176221_1_.func_177229_b(field_176387_N)).func_176740_k();
      if(var4 == EnumFacing.Axis.Z && (p_176221_2_.func_180495_p(p_176221_3_.func_177976_e()).func_177230_c() == Blocks.field_150463_bK || p_176221_2_.func_180495_p(p_176221_3_.func_177974_f()).func_177230_c() == Blocks.field_150463_bK) || var4 == EnumFacing.Axis.X && (p_176221_2_.func_180495_p(p_176221_3_.func_177978_c()).func_177230_c() == Blocks.field_150463_bK || p_176221_2_.func_180495_p(p_176221_3_.func_177968_d()).func_177230_c() == Blocks.field_150463_bK)) {
   ...
   public AxisAlignedBB func_180640_a(World p_180640_1_, BlockPos p_180640_2_, IBlockState p_180640_3_) {
      if(((Boolean)p_180640_3_.func_177229_b(field_176466_a)).booleanValue()) {
         ...
         EnumFacing.Axis var4 = ((EnumFacing)p_180640_3_.func_177229_b(field_176387_N)).func_176740_k();
         return var4 == EnumFacing.Axis.Z?new AxisAlignedBB((double)p_180640_2_.func_177958_n(), (double)p_180640_2_.func_177956_o(), (double)((float)p_180640_2_.func_177952_p() + 0.375F), (double)(p_180640_2_.func_177958_n() + 1), (double)((float)p_180640_2_.func_177956_o() + 1.5F), (double)((float)p_180640_2_.func_177952_p() + 0.625F)):new AxisAlignedBB((double)((float)p_180640_2_.func_177958_n() + 0.375F), (double)p_180640_2_.func_177956_o(), (double)p_180640_2_.func_177952_p(), (double)((float)p_180640_2_.func_177958_n() + 0.625F), (double)((float)p_180640_2_.func_177956_o() + 1.5F), (double)(p_180640_2_.func_177952_p() + 1));
      }
   }

   public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
      EnumFacing.Axis var3 = ((EnumFacing)p_180654_1_.func_180495_p(p_180654_2_).func_177229_b(field_176387_N)).func_176740_k();
   ...
   public boolean func_180639_a(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumFacing p_180639_5_, float p_180639_6_, float p_180639_7_, float p_180639_8_) {
      if(((Boolean)p_180639_3_.func_177229_b(field_176466_a)).booleanValue()) {
         ...
         EnumFacing var9 = EnumFacing.func_176733_a((double)p_180639_4_.field_70177_z);
         if(p_180639_3_.func_177229_b(field_176387_N) == var9.func_176734_d()) {
            p_180639_3_ = p_180639_3_.func_177226_a(field_176387_N, var9);
         }
   ...
   public void func_176204_a(World p_176204_1_, BlockPos p_176204_2_, IBlockState p_176204_3_, Block p_176204_4_) {
      if(!p_176204_1_.field_72995_K) {
         ...
         if(var5 || p_176204_4_.func_149744_f()) {
            if(var5 && !((Boolean)p_176204_3_.func_177229_b(field_176466_a)).booleanValue() && !((Boolean)p_176204_3_.func_177229_b(field_176465_b)).booleanValue()) {
            ...
            } else if(!var5 && ((Boolean)p_176204_3_.func_177229_b(field_176466_a)).booleanValue() && ((Boolean)p_176204_3_.func_177229_b(field_176465_b)).booleanValue()) {
            ...
            } else if(var5 != ((Boolean)p_176204_3_.func_177229_b(field_176465_b)).booleanValue()) {
               p_176204_1_.func_180501_a(p_176204_2_, p_176204_3_.func_177226_a(field_176465_b, Boolean.valueOf(var5)), 2);
            }
         }
