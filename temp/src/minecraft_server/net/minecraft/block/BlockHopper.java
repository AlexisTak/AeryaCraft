...
public class BlockHopper extends BlockContainer {
   ...
   public IBlockState func_180642_a(World p_180642_1_, BlockPos p_180642_2_, EnumFacing p_180642_3_, float p_180642_4_, float p_180642_5_, float p_180642_6_, int p_180642_7_, EntityLivingBase p_180642_8_) {
      EnumFacing var9 = p_180642_3_.func_176734_d();
      if(var9 == EnumFacing.UP) {
         var9 = EnumFacing.DOWN;
      }

      return this.func_176223_P().func_177226_a(field_176430_a, var9).func_177226_a(field_176429_b, Boolean.valueOf(true));
   }
   ...
   public void func_180633_a(World p_180633_1_, BlockPos p_180633_2_, IBlockState p_180633_3_, EntityLivingBase p_180633_4_, ItemStack p_180633_5_) {
      ...
      if(p_180633_5_.func_82837_s()) {
         ...
         if(var6 instanceof TileEntityHopper) {
            ((TileEntityHopper)var6).func_145886_a(p_180633_5_.func_82833_r());
         }
      }
   ...
   public boolean func_180639_a(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumFacing p_180639_5_, float p_180639_6_, float p_180639_7_, float p_180639_8_) {
      if(p_180639_1_.field_72995_K) {
         ...
         if(var9 instanceof TileEntityHopper) {
            p_180639_4_.func_71007_a((TileEntityHopper)var9);
         }
   ...
   private void func_176427_e(World p_176427_1_, BlockPos p_176427_2_, IBlockState p_176427_3_) {
      boolean var4 = !p_176427_1_.func_175640_z(p_176427_2_);
      if(var4 != ((Boolean)p_176427_3_.func_177229_b(field_176429_b)).booleanValue()) {
         p_176427_1_.func_180501_a(p_176427_2_, p_176427_3_.func_177226_a(field_176429_b, Boolean.valueOf(var4)), 4);
      }
   ...
   public void func_180663_b(World p_180663_1_, BlockPos p_180663_2_, IBlockState p_180663_3_) {
      ...
      if(var4 instanceof TileEntityHopper) {
         InventoryHelper.func_180175_a(p_180663_1_, p_180663_2_, (TileEntityHopper)var4);
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      byte var2 = 0;
      int var3 = var2 | ((EnumFacing)p_176201_1_.func_177229_b(field_176430_a)).func_176745_a();
