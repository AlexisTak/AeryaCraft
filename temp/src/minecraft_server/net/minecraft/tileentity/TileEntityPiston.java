...
public class TileEntityPiston extends TileEntity implements IUpdatePlayerListBox {
   ...
   private void func_145863_a(float p_145863_1_, float p_145863_2_) {
      ...
      AxisAlignedBB var3 = Blocks.field_180384_M.func_176424_a(this.field_145850_b, this.field_174879_c, this.field_174932_a, p_145863_1_, this.field_174931_f);
      if(var3 != null) {
         ...
         if(!var4.isEmpty()) {
            ...
            while(var5.hasNext()) {
               ...
               if(this.field_174932_a.func_177230_c() == Blocks.field_180399_cE && this.field_145875_k) {
                  switch(TileEntityPiston.SwitchAxis.field_177248_a[this.field_174931_f.func_176740_k().ordinal()]) {
                  case 1:
                  ...
                  var6.func_70091_d((double)(p_145863_2_ * (float)this.field_174931_f.func_82601_c()), (double)(p_145863_2_ * (float)this.field_174931_f.func_96559_d()), (double)(p_145863_2_ * (float)this.field_174931_f.func_82599_e()));
               }
            }
