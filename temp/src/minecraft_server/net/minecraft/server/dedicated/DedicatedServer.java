...
public class DedicatedServer extends MinecraftServer implements IServer {
   ...
   private final List field_71341_l = Collections.synchronizedList(Lists.newArrayList());
   ...
   protected boolean func_71197_b() throws IOException {
      ...
      var1.setDaemon(true);
      var1.start();
      field_155771_h.info("Starting minecraft server version 1.8");
      ...
      if(!this.field_154332_n.func_154346_a()) {
         ...
         try {
            ...
            field_155771_h.warn("The exception was: {}", new Object[]{var17.toString()});
         ...
         if(!PreYggdrasilConverter.func_152714_a(this.field_71340_o)) {
            ...
            WorldType var18 = WorldType.func_77130_a(var7);
            if(var18 == null) {
               var18 = WorldType.field_77137_b;
            }
            ...
            this.func_71247_a(this.func_71270_I(), this.func_71270_I(), var9, var18, var8);
   ...
   public void func_70000_a(PlayerUsageSnooper p_70000_1_) {
      p_70000_1_.func_152768_a("whitelist_enabled", Boolean.valueOf(this.func_180508_aN().func_72383_n()));
      p_70000_1_.func_152768_a("whitelist_count", Integer.valueOf(this.func_180508_aN().func_152598_l().length));
   ...
   public boolean func_175579_a(World p_175579_1_, BlockPos p_175579_2_, EntityPlayer p_175579_3_) {
      if(p_175579_1_.field_73011_w.func_177502_q() != 0) {
         return false;
      } else if(this.func_180508_aN().func_152603_m().func_152690_d()) {
         return false;
      } else if(this.func_180508_aN().func_152596_g(p_175579_3_.func_146103_bH())) {
         return false;
      } else if(this.func_82357_ak() <= 0) {
         return false;
      } else {
         BlockPos var4 = p_175579_1_.func_175694_M();
         int var5 = MathHelper.func_76130_a(p_175579_2_.func_177958_n() - var4.func_177958_n());
         int var6 = MathHelper.func_76130_a(p_175579_2_.func_177952_p() - var4.func_177952_p());
