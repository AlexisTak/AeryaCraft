...
public class Potion {
   ...
   public static final Potion field_76444_x = (new PotionAbsoption(22, new ResourceLocation("absorption"), false, 2445989)).func_76390_b("potion.absorption").func_76399_b(2, 2);
