...
public class ItemLegendary extends Item {
	...
	public boolean getIsRepairable(ItemStack toRepair, ItemStack repair) {
		return this.repairMaterial.getBaseItemForRepair() == repair.getItem() ? true
	...
	public Multimap getItemAttributeModifiers() {
		...
		var1.put(SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(),
				new AttributeModifier(itemModifierUUID, "Weapon modifier", (double) this.field_150934_a, 0));
		return var1;
	}

	public EnumRarity getRarity(ItemStack stack) {
		return stack.getMetadata() == 2 ? EnumRarity.LEGENDARY : EnumRarity.LEGENDARY;
	}
